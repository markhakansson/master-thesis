...
of a resource.  When reaching these breakpoints the current cycle counter can
be recorded.  There is also an additional breakpoint inside the patched
...
immediate value. A simplified code example of the replay harness can be
