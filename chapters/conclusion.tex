...
arithmetic overflow. Therefore, RAUK is not limited to perform a schedulability
analysis check, but can also be used for generating test cases to verify that
there is no such errors present in the application, improving reliability of
the program.
