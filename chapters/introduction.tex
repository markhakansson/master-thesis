...
failures are called \emph{hard} real-time systems.
...
programs, to show that RTIC applications can meet the same requirements.
...
possible to use a monotonic timer to easier execute software tasks in the future
