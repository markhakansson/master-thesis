...
sorted, the amount of possible paths will increase exponentially for increasing
sizes of input.

Generally, data dependant code is undesirable in the context of real-time
