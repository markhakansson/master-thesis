...
paper\cite{srp}, it only needs to follow certain conditions which will not be explained
...
task}. Which can be triggered inside of the application itself. All tasks can be
