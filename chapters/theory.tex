...
resources and connect tasks to dispatchers and interrupts. As well as functions
for updating resource priorities which is required to adhere to the stack
resource policy.
